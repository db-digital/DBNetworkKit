#
#  Be sure to run `pod spec lint DBNetworkKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  A small framework to manage the Network requests in the apps.
                   DESC
  ...
  # Or just: spec.author    = "Nitin"
  # spec.authors            = { "Nitin" => "nitin.kumar@dbdigital.in" }
  # spec.social_media_url   = "https://twitter.com/Nitin"
  ...
  spec.source_files  = "DBNetworkKit", "DBNetworkKit/**/*.{h,m}"
